...
{
    public class CustomWebApplicationFactory(GlobalJwksServer jwks) : WebApplicationFactory<AccountService.Program>
    {
        ...
        protected override void ConfigureWebHost(IWebHostBuilder builder)
        {
            ...
            builder.ConfigureServices(services =>
            {
                ...
                var db = scope2.ServiceProvider.GetRequiredService<AccountDbContext>();
